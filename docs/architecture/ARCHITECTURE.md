...
The former god-module `libraries/framework` was split into five infrastructure modules that
...
graph TD
    ...
    classDef infra fill:#036A99,stroke:#088DF3,color:#fff
    classDef feat fill:#867C04,stroke:#fbc02d,color:#fff
    class APP,SHELL host
    class CORE,FRAMEWORK,NETWORK,UIKIT,ROUTES,BUS,FE infra
