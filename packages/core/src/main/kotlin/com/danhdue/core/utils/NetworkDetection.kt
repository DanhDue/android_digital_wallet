...
import com.danhdue.core.extension.sampleAndKeepLast
...
class NetworkDetection(
    ...
    private val networkConnectivityReceiver =
    ...
    private suspend fun makeProbeRequest(): InternetStatus {
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                pingConnection =
                    if (url.startsWith(REQUEST_PROTOCOL, true)) {
