...
| Module | Package | Role |
|---|---|---|
| `:packages:core` | `com.danhdue.core` | Dependency floor: `DataState` / `NetworkResponse`, `DispatcherProvider`, `extension/*`, `pref/*`, `room/*`, `SessionManager`, `usecase/*`, `Logger`, `AppInitializer`. Compose-free, no project dependencies. |
